    ...
    <div className="bg-accent p-4 md:p-6 h-full overflow-y-auto">
      ...
      <main className="text-white rounded-lg bg-accent-foreground w-full p-4 md:p-6 space-y-10">
        ...
        <div className="flex justify-center">
          <div className="w-full max-w-xl py-7 md:py-12 bg-linear-to-br from-amber-500 via-amber-600 to-amber-800 rounded-3xl p-8 shadow-2xl border border-amber-400 relative overflow-hidden">
            {/* Background pattern */}
