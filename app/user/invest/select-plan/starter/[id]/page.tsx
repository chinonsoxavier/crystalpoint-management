...
const Page = () => {
  ...
  const { activateInvestment, isActivatingInvestment,investmentSuccessfull,resetInvestmentSuccessfull } = useInvestStore();
        ...
        <div className="text-center space-y-8 max-w-md">
          ...
          <div className="space-y-4">
            ...
            <p className="text-lg text-accent-text/80">
              ...
              Cristalpoint Starter plan has been activated.
            </p>
          ...
          <div className="bg-accent-foreground rounded-lg p-8">
            <form className="max-w-4xl" onSubmit={handleSubmit}>
              <div className="space-y-2 mb-6">
                ...
                <p className="">
                  You are about to make an investment under Cristalpoint Starter
                  Plan
                </p>
              </div>
