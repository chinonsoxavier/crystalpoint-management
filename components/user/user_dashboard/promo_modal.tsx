                ...
                <Link href="/user/deposit">
                  ...
                  >
                    <div className="relative p-5 md:p-8 space-y-3.5 md:space-y-6">
                      ...
                      {/* Investment Range */}
                      <div className="md:py-4 py-2.5 border-b border-gray-800/50">
                      ...
                      <div className="bg-linear-to-r from-emerald-600/10 to-blue-600/10 rounded-2xl p-3.5 md:p-6 text-center border border-emerald-500/20">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div className="bg-accent/50 rounded-xl center-col p-4 text-center border border-gray-700/50">
                      ...
                      <div className="text-center">
                        <span
                          className={`inline-block px-4 py-1.5 md:py-2 rounded-full text-sm font-bold ${
                            plan.risk === "Low"
