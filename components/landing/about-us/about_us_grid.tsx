...
const AboutUsGrid = () => {
  return (
    <div className="sm:grid grid-rows-5 grid-cols-3 gap-4 flex flex-col sm:max-h-[600px] w-full h-full max_width">
      ...
      <Animate
        className="row-start-1 relative rounded-2xl center row-end-3 col-start-1 col-end-2 bg-green-400/50"
      >
        <Image className="object-cover w-full h-full rounded-2xl" alt="gallery image 1" src={gridImage1} />
      </Animate>

      <Animate
        className="row-start-3 relative rounded-2xl center row-end-5 col-start-1 col-end-2 bg-lime-300/50"
      >
        <Image className="object-cover w-full h-full rounded-2xl" alt="gallery image 4" src={gridImage4} />
      </Animate>

      {/* Second Column - Center with Unique Cert */}
      <Animate
        className="row-start-1 relative rounded-2xl center row-end-2 col-start-2 col-end-3 bg-red-500/50"
      >
        <Image className="object-cover w-full h-full rounded-2xl" alt="gallery image 2" src={gridImage2} />
      </Animate>
...
>
  ...
  <div className="relative z-10 w-full h-full rounded-2xl overflow-hidden">
    ...
    />
      ...
      <Animate
        className="row-start-4 relative rounded-2xl center row-end-5 col-start-2 col-end-3 bg-lime-500/50"
      >
        <Image className="object-cover w-full h-full rounded-2xl" alt="gallery image 5" src={gridImage5} />
      </Animate>

      {/* Third Column - Shifted up */}
      <Animate
        className="row-start-1 relative rounded-2xl center row-end-3 col-start-3 col-end-4 bg-lime-200/50"
      >
        <Image className="object-cover w-full h-full rounded-2xl" alt="gallery image 3" src={gridImage3} />
      </Animate>

      <Animate
        className="row-start-3 relative rounded-2xl center row-end-5 col-start-3 col-end-4 bg-cyan-700/50"
      >
        <Image className="object-cover w-full h-full rounded-2xl" alt="gallery image 6" src={gridImage6} />
      </Animate>
    </div>
  );
}
